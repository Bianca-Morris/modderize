	...
	return (
		<ContentBody>
			...
			<div className="my-5 flex-col flex gap-5">
				...
				<p>
					The Modderize website located at modderize.me is a
					copyrighted work belonging to Modderize. Certain features of
				...
				<p>
					<strong>Subject to these Terms.</strong> Modderize grants
				...
				<p>
					Modderize reserves the right to change, suspend, or cease
					the Site with or without notice to you.  You approved that
					Modderize will not be held liable to you or any third-party
				...
				<p>
					...
					Modderize will have no obligation to provide you with any
				...
				<p>
					...
					Site and its content are owned by Modderize or
					Modderize&apos;s suppliers. Note that these Terms and access
					to the Site do not give you any rights, title or interest in
					or to any intellectual property rights, except for the
					limited access rights expressed in Section 2.1. Modderize
				...
				<p>
					...
					submits to the Site. You are exclusively responsible for
					your User Content. You bear all risks associated with use of
					your User Content.  You hereby certify that your User
					Content does not violate our Acceptable Use Policy.  You may
					not represent or imply to others that your User Content is
					in any way provided, sponsored or endorsed by Modderize.
					Because you alone are responsible for your User Content, you
					may expose yourself to liability. Modderize is not obliged
					to backup any User Content that you post; also, your User
					Content may be deleted at any time without prior notice to
					you. You are solely responsible for making your own backup
					copies of your User Content if you desire.
				</p>

				<p>
					You hereby grant to Modderize an irreversible, nonexclusive,
				...
				<p>
					...
					constitute our &quot;Acceptable Use Policy&quot;: You agree
				...
				<p>
					If you provide Modderize with any feedback or suggestions
					regarding the Site, you hereby assign to Modderize all
					rights in such Feedback and agree that Modderize shall have
					the right to use and fully exploit such Feedback and related
					information in any manner it believes appropriate. 
					Modderize will treat any Feedback you provide to Modderize
					as non-confidential and non-proprietary.
				</p>

				<p>
					You agree to indemnify and hold Modderize and its officers,
					...
					Modderize reserves the right to assume the exclusive defense
					...
					the prior written consent of Modderize.  Modderize will use
				...
				<p>
					...
					Links & Ads are not under the control of Modderize, and
					Modderize is not responsible for any Third-Party Links &
					Ads.  Modderize provides access to these Third-Party Links &
				...
				<p>
					...
					Modderize will not be responsible for any loss or damage
				...
				<p>
					You hereby release and forever discharge the Modderize and
					...
					the foregoing, which states: &quot;a general release does
				...
				<p>
					...
					all warranties or conditions of merchantability, fitness for
				...
				<p>
					...
					databases.  Modderize will not have any liability whatsoever
				...
				<p>
					Modderize respects the intellectual property of others and
				...
				<p>
					...
					for any damages, costs and attorney&apos;s fees incurred by
					us in connection with the written notification and
				...
				<p>
					...
					contract with Modderize and affects your rights.  It
				...
				<p>
					...
					of any product or service provided by the Modderize that
					...
					and the Modderize, and to any subsidiaries, affiliates,
				...
				<p>
					...
					the requested relief.  A Notice to the Modderize should be
					sent to: biancaallynm@protonmail.com. After the Notice is
					received, you and the Modderize may attempt to resolve the
					claim or dispute informally.  If you and the Modderize do
				...
				<p>
					...
					greater than the last settlement offer that the Modderize
					made to you prior to the initiation of arbitration, the
					Modderize will pay you the greater of the award or
				...
				<p>
					<strong>Time Limits.</strong> If you or the Modderize
				...
				<p>
					...
					liabilities of you and the Modderize, and the dispute will
					...
					binding upon you and the Modderize.
				</p>
				...
				<p>
					...
					Modderize in any state or federal court in a suit to vacate
					or enforce an arbitration award or otherwise, YOU AND THE
				...
				<p>
					...
					foregoing, either you or the Modderize may bring an
				...
				<p>
					...
					of the courts located within us County, California, for such
					purposes.
				</p>
				...
				<p>
					...
					from Modderize, or any products utilizing such data, in
				...
				<p>
					...
					communications between you and Modderize use electronic
					means, whether you use the Site or send us emails, or
					whether Modderize posts notices on the Site or communicates
					with you via email. For contractual purposes, you (a)
					consent to receive communications from Modderize in an
					electronic form; and (b) agree that all terms and
					conditions, agreements, notices, disclosures, and other
					communications that Modderize provides to you electronically
				...
				<p>
					...
					held to be invalid or unenforceable, the other provisions of
					these Terms will be unimpaired and the invalid or
					unenforceable provision will be deemed modified so that it
					is valid and enforceable to the maximum extent permitted by
					law.  Your relationship to Modderize is that of an
					...
					Modderize&apos;s prior written consent, and any attempted
					assignment, subcontract, delegation, or transfer in
					violation of the foregoing will be null and void.  Modderize
				...
				<p>Email: biancaallynm@protonmail.com</p>
			</div>
		</ContentBody>
	);
};
