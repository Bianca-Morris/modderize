		...
		<ContentBody>
			...
			<div className="my-5 flex-col flex gap-5">
				...
				<p>
					...
					Site and its content are owned by Modderize or Modderize's
					...
					rights expressed in Section 2.1. Modderize and its suppliers
				...
				<p>
					...
					sponsored or endorsed by Modderize. Because you alone are
					responsible for your User Content, you may expose yourself
					to liability. Modderize is not obliged to backup any User
				...
				<p>
					...
					relationship to Modderize is that of an independent
					...
					transferred by you without Modderize's prior written
					consent, and any attempted assignment, subcontract,
					delegation, or transfer in violation of the foregoing will
					be null and void.  Modderize may freely assign these Terms. 
